            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: ListView(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      child: Image.asset('repo/image/cow.png', width: 80),
                      onTap: () {
                        _imagePath = 'repo/image/cow.png';
                      },
                    ),
                    GestureDetector(
                      child: Image.asset('repo/image/pig.png', width: 80),
                      onTap: () {
                        _imagePath = 'repo/image/pig.png';
                      },
                    ),
                    GestureDetector(
                      child: Image.asset('repo/image/bee.png', width: 80),
                      onTap: () {
                        _imagePath = 'repo/image/bee.png';
                      },
                    ),
                    GestureDetector(
                      child: Image.asset('repo/image/cat.png', width: 80),
                      onTap: () {
                        _imagePath = 'repo/image/cat.png';
                      },
                    ),
                    GestureDetector(
                      child: Image.asset('repo/image/dog.png', width: 80),
                      onTap: () {
